...
class ShoppingAgent:
    ...
    def respond(self, session_id: str, user_message: str, turn: int, top_k: int) -> dict:
        ...
        if os.environ.get("AGENT_FUNNEL") == "1" and state.funnel:
            # Off by default: the contract defines the scored fields, and an
            # unexpected key is not worth the risk of a stricter validator.
            response["funnel"] = state.funnel[-1]
        return response
